...
def main():
    ...
    settings.set('FEED_EXPORT_FIELDS', [
        ...
        'Highlight Header 3',
        'Highlight Description 3',
        'Highlight Header 4',
        'Highlight Description 4',
        'Highlight Header 5',
        'Highlight Description 5',
        'Highlight Header 6',
        'Highlight Description 6',
        'Highlight Header 7',
        'Highlight Description 7',
        'Highlight Header 8',
        'Highlight Description 8',
        'Highlight Header 9',
        'Highlight Description 9',
        'Highlight Header 10',
        'Highlight Description 10',
        'Highlight Header 11',
        'Highlight Description 11',
        'Highlight Header 12',
        'Highlight Description 12',
        'Highlight Header 13',
        'Highlight Description 13',
        'Highlight Header 14',
        'Highlight Description 14',
        'Highlight Header 15',
        'Highlight Description 15'
    ])
